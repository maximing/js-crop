...
var crop = {
    ...
    init: function () {
        /**
         * Загрузка оригинальной фотографии на сервер
        ...
        $(document).on('change', '#load-photo', function (e) {
            ...
            /**
             * AJAX запрос на сервер для загрузки фотографии
             *
             * Request payload:
        ...
        /**
         * Загрузка кадрированной фотографии на сервер
         * и отображение ее в блоке на странице портала
         */
